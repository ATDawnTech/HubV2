...
from .config_tables import SkillsCatalog, AssetCategory, Role, Permission, RoleAssignment, RoleGrantPermission, ConfigDropdown, SystemSetting, OwnerGroup, GroupMember, NotificationSettings, NotificationModuleToggle
