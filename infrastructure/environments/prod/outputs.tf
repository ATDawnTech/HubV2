...
output "cloudfront_distribution_id" {
  description = "CloudFront distribution ID — used for cache invalidation in deploy-prod.yml."
  value       = module.frontend.cloudfront_distribution_id
}

output "github_actions_role_arn" {
  value       = module.github_oidc.role_arn
  description = "IAM Role ARN for GitHub Actions. Add to GitHub Secrets as AWS_PROD_DEPLOY_ROLE."
}
